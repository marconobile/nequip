...
def model_from_config(
    ...
    if type_mapper is not None:
        ...
        config["num_types"] = type_mapper.num_types # 2
        config["type_names"] = type_mapper.type_names # ['H', 'C']

    # Build
    builders = [
        load_callable(b, prefix="nequip.model") # prefix acts as scoping to import each Network module
